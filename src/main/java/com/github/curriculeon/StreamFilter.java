...
public class StreamFilter {
    ...
    public StreamFilter() {
        ...
        Stream.generate(personFactory::createRandomPerson)
                .limit(100)
    ...
    public List<Person> toListMultiLine() {
        List<Person> personList = new ArrayList<>();
        personStream.filter(person -> person.getName().charAt(0)==this.startingCharacter.charAt(0))
                .forEach(personList::add);
